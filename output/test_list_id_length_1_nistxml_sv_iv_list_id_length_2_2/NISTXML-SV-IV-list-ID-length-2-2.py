...
obj = Out(
    any_element=NistschemaSvIvListIdLength2(
        value=[
            'scomplete-tests_signatures',
            '_manipulation_repository.t',
            'kinformation_the.repositor',
            'jbusiness-oriented-underst',
            'irepository.to-the.be_and_',
            '_tools-the.them.and_provid',
        ]
    )
)
