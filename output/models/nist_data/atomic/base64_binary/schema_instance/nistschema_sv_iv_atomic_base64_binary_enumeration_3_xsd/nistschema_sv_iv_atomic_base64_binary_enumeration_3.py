...
class NistschemaSvIvAtomicBase64BinaryEnumeration3Type(Enum):
    ...
    C_XNRA_WVX_YWN1_ZXH5B3_F0DM_RN_Z2_ZNB_GL2E_GRSD_GK = (
        b"qskieqacuexyoqtvdggfglivxdlti"
    )
    CN_VM_ZGRUC_WV5C3_ZS_Z2_ZZD_GVY_ZHLYB2_VTA_GFTB211C_G50E_HN3 = (
        b"rufddnqeysvlgfsterdyroemhamomupntxsw"
    )
...
class NistschemaSvIvAtomicBase64BinaryEnumeration3:
    ...
    value: NistschemaSvIvAtomicBase64BinaryEnumeration3Type = field(
        metadata={
            "format": "base64",
        }
    )
