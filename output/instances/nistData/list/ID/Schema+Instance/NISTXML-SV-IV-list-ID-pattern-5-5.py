...
obj = Out(
    any_element=NistschemaSvIvListIdPattern5(
        value=[
            'qon-and.for_and-a.location_design_needs_software.between.rep',
            'ffor-academia_them-creation_mediums_into.documents_d',
            'mthe_which.on_must.of.and-high_further-the-organiz',
            'xfollowing.only.software-resources-emerging.',
            'tbandwidth_manipulate-that-sy',
            'othis_commer',
            'cinvestigations_reference-ind',
            'ythrough_informa',
        ]
    )
)
