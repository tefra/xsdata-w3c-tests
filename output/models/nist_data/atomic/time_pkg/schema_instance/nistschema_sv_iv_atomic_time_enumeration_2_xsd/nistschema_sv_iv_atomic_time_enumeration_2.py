...
class NistschemaSvIvAtomicTimeEnumeration2Type(Enum):
    VALUE_10_32_33 = time(10, 32, 33)
    VALUE_11_18_46 = time(11, 18, 46)
    VALUE_06_00_33 = time(6, 0, 33)
    VALUE_14_01_48 = time(14, 1, 48)
    VALUE_11_14_02 = time(11, 14, 2)
    VALUE_02_02_10 = time(2, 2, 10)
