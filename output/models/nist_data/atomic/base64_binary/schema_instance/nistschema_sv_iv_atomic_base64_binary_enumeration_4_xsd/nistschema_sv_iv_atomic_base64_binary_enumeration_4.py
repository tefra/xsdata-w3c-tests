...
class NistschemaSvIvAtomicBase64BinaryEnumeration4Type(Enum):
    ...
    ZXJUE_G91C_G9Z_YMTWC_XZLE_GHME_HLJC3_RSD_WDQC_XA = (
        b"ernxouposbkpqvexhfxycstlugjqp"
    )
    ...
    YM_Z1C21MD3_R2BMD3BN_Z4CN_RUB_G15C_HJHAM_FSB2_RSCG = (
        b"bfusmfwtvngwnvxrtnlmyprajalodlr"
    )
...
class NistschemaSvIvAtomicBase64BinaryEnumeration4:
    ...
    value: NistschemaSvIvAtomicBase64BinaryEnumeration4Type = field(
        metadata={
            "required": True,
            "format": "base64",
        }
