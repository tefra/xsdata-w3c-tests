...
class NistschemaSvIvAtomicHexBinaryEnumeration4Type(Enum):
    ...
    VALUE_64616C6A716D72626B76796479706871726C7461716F67767362667264776F67 = b"daljqmrbkvydyphqrltaqogvsbfrdwog"
    VALUE_6873616774666A696269777162716F78766863727777797765656F74 = b"hsagtfjibiwqbqoxvhcrwwyweeot"
...
class NistschemaSvIvAtomicHexBinaryEnumeration4:
    ...
    value: Optional[NistschemaSvIvAtomicHexBinaryEnumeration4Type] = field(
        default=None,
        metadata={
            "required": True,
            "format": "base16",
