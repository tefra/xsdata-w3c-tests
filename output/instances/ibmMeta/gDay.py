    ...
    annotation=[
        Annotation(
            appinfo_or_documentation=[
                Documentation(
                    other_attributes={
                        "{http://www.w3.org/1999/xlink}href": "http://www.w3.org/TR/xmlschema11-2/#gDay",
                    },
                    content=[
                        "gDay",
                    ]
        ...
        TestGroup(
            ...
            documentation_reference=[
                DocumentationReference(
                    href="http://www.w3.org/TR/xmlschema11-2/#gDay"
                ),
                DocumentationReference(
            ...
            schema_test=SchemaTest(
                schema_document=[
                    SchemaDocument(
                        href="../ibmData/valid/D3_3_14/d3_3_14v01.xsd"
                    ),
                ],
                expected=[
                    Expected(
            ...
            instance_test=[
                InstanceTest(
                    instance_document=InstanceDocument(
                        href="../ibmData/valid/D3_3_14/d3_3_14v01.xml"
                    ),
                    expected=[
                        Expected(
                            validity=ExpectedOutcome.VALID
