...
class NistschemaSvIvListLanguageEnumeration1:
    ...
    value: NistschemaSvIvListLanguageEnumeration1Type = field(
        metadata={
            "required": True,
        }
    )
