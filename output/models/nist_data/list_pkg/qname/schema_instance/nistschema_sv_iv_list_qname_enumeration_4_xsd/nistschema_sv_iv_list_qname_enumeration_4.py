...
class NistschemaSvIvListQnameEnumeration4Type(Enum):
    """
    :cvar VALUE_DATA_COMM_OAND_TO_AS_AND_S_EACH_DO_REPOSITORY_SPE_KRELATED_DISCOVERY_CONFOR_RDI_THE_IIS_DESKTOP_INFORMATION_IN_FILTE_YPROFILES_SPECIFICATIONS_IS_ASS_IPROC_XFILE_AND:
    :cvar VALUE_SERIE_YAN_SIMULATION_SUCH_BACK_EACH_MAN_WITH_VCOMPUTING_THE_OF_BUILDING_KEY_MAINTAINS_ADVANCED_THE_STAKEHOL_NOF_FOUR_INFORMATION_TO_SSIGNATURES_SET_FILE_AND_OBJECT_THE_IS_INFORMATION_THE_MENVIRONMENT_FOR_SUPPLY_OF_DEVEL_QALSO_CORRECTION_IN_CONTEXT_RICH_AND_IS_D_EPROVIDED_TO_PADVENT_ITS_TESTABLE_THEM_BANDWIDTH_MO_VAND_CONSOR_DATA_COMM_OAND_TO_AS_AND_S:
    ...
    """
    VALUE_DATA_COMM_OAND_TO_AS_AND_S_EACH_DO_REPOSITORY_SPE_KRELATED_DISCOVERY_CONFOR_RDI_THE_IIS_DESKTOP_INFORMATION_IN_FILTE_YPROFILES_SPECIFICATIONS_IS_ASS_IPROC_XFILE_AND = "_data.comm:oand-to.as_and-s _each_do-repository.spe:krelated_discovery.confor rdi:_the. iis_desktop_information_in _filte:yprofiles_specifications.is_ass iproc:xfile-and_"
    VALUE_SERIE_YAN_SIMULATION_SUCH_BACK_EACH_MAN_WITH_VCOMPUTING_THE_OF_BUILDING_KEY_MAINTAINS_ADVANCED_THE_STAKEHOL_NOF_FOUR_INFORMATION_TO_SSIGNATURES_SET_FILE_AND_OBJECT_THE_IS_INFORMATION_THE_MENVIRONMENT_FOR_SUPPLY_OF_DEVEL_QALSO_CORRECTION_IN_CONTEXT_RICH_AND_IS_D_EPROVIDED_TO_PADVENT_ITS_TESTABLE_THEM_BANDWIDTH_MO_VAND_CONSOR_DATA_COMM_OAND_TO_AS_AND_S = "_serie:yan.simulation_such_back.each-man _with:vcomputing-the-of.building_key_maintains_advanced-the- _stakehol:nof.four-information.to ssignatures_set_file.:_and_object-the_is-information-the menvironment.for-supply-of.devel qalso.correction_in.context-rich_and.is_d eprovided_to_:padvent.its-testable-them.bandwidth_mo vand-consor _data.comm:oand-to.as_and-s"
