...
class NistschemaSvIvAtomicNcnameEnumeration1Type(Enum):
    """
    :cvar VALUE_IS_KNOWN_MUST_MANIPULATE_TO_REFER:
    :cvar VALUE_IS_TESTING_REGISTRY_FOR_COME_POPULAR_NETWORKING_IS_BETWE:
    ...
    """
    VALUE_IS_KNOWN_MUST_MANIPULATE_TO_REFER = "_is-known.must_manipulate-to_refer"
    VALUE_IS_TESTING_REGISTRY_FOR_COME_POPULAR_NETWORKING_IS_BETWE = "_is-testing.registry_for_come_popular-networking-is-betwe"
