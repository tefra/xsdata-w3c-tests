...
obj = Out(
    any_element=NistschemaSvIvListIdPattern5(
        value=[
            'xcomplex.languages_for.complex-build_discover.the.known-invo',
            'othem_to.for_blocks_to_needed-rigorous.a_prototypes_',
            'qorganization-the.the_commerce_dependability_conte',
            '_exchange-in.of-that-offer.issues_correction',
            'mindustry.can.to_five_clean_a',
            'jof.define.i',
            'capplication_formed-the-inclu',
            'vvisibly-reposit',
        ]
    )
)
