...
obj = Out(
    any_element=NistschemaSvIvListIdPattern5(
        value=[
            'asensors.guidelines_participating.filter.the-and-and.of-appr',
            'wfor.rich_discussions.participating-the_to.is_and-sp',
            '_to-full_business.joint-must_foster.the.understand',
            '_from-a-and_desktop.and-heterogeneous.same-s',
            'dperformance_heterogeneous_st',
            'nto-of-speci',
            '_provide-other_templates.test',
            'gcan-act.and.inc',
        ]
    )
)
