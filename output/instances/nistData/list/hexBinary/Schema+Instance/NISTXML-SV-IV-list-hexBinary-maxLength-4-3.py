...
obj = NistschemaSvIvListHexBinaryMaxLength4(
    value=[
        b"yxatodfciuuthpyryljeujqbgqos",
        b"tprkhnbfnmsliayvsrjywyyapdwl",
        b"pnvpwilfqyalpwoelgjlejkeenuq",
        b"mqsukdlnfrfftcjscymomgsktmfv",
        b"fjuuuulvroewdnajqtssmeiclbye",
    ]
)
