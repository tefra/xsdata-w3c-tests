...
class NistschemaSvIvAtomicBase64BinaryEnumeration2Type(Enum):
    ...
    ZGDQB_G5HC2TZE_WN2B_W5QC_HDHCNHUCN_FND_XZIC_XF5CM_RJ = (
        b"dgjlnasksycvmnjpwarxnrqguvbqqyrdc"
    )
    ...
    C_WFO_YND1D_GZLE_WV3D3_RRA3_NPBN_FI_ZGNQAMDRC_WF4_YXZ5_Y3_RI = (
        b"qahbwutfeyewwtkksinqbdcjjgkqaxavyctb"
    )
...
class NistschemaSvIvAtomicBase64BinaryEnumeration2:
    ...
    value: NistschemaSvIvAtomicBase64BinaryEnumeration2Type = field(
        metadata={
            "format": "base64",
        }
    )
